...
COMMENT ON SCHEMA bdms IS '1.0.0';
...
CREATE TABLE bdms.users (
    ...
    CONSTRAINT users_id_grp_fk_fkey FOREIGN KEY (id_grp_fk)
        REFERENCES bdms.groups (id_grp) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);
...
(
    ...
    created_bho timestamp without time zone DEFAULT now(),

    update_bho timestamp without time zone DEFAULT now(),
    updater_bho integer,
    ...
    published_bho timestamp without time zone,
    ...
    date_bho timestamp without time zone,
    ...
    CONSTRAINT borehole_pkey PRIMARY KEY (id_bho),
    CONSTRAINT borehole_id_wgp_fk_fkey FOREIGN KEY (id_wgp_fk)
        REFERENCES bdms.workgroups (id_wgp) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_locked_by_fkey FOREIGN KEY (locked_by)
        REFERENCES bdms.users (id_usr) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE SET NULL,
    CONSTRAINT borehole_updater_bho_fkey FOREIGN KEY (updater_bho)
        REFERENCES bdms.users (id_usr) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_canton_bho_fkey FOREIGN KEY (canton_bho)
        REFERENCES bdms.cantons (gid) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_city_bho_fkey FOREIGN KEY (city_bho)
        REFERENCES bdms.municipalities (gid) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_kind_id_cli_fkey FOREIGN KEY (kind_id_cli)
        REFERENCES bdms.codelist (id_cli) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_srs_id_cli_fkey FOREIGN KEY (srs_id_cli)
        REFERENCES bdms.codelist (id_cli) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_hrs_id_cli_fkey FOREIGN KEY (hrs_id_cli)
        REFERENCES bdms.codelist (id_cli) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_restriction_id_cli_fkey FOREIGN KEY (restriction_id_cli)
        REFERENCES bdms.codelist (id_cli) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_qt_location_id_cli_fkey FOREIGN KEY (qt_location_id_cli)
        REFERENCES bdms.codelist (id_cli) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_qt_elevation_id_cli_fkey FOREIGN KEY (qt_elevation_id_cli)
        REFERENCES bdms.codelist (id_cli) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_landuse_id_cli_fkey FOREIGN KEY (landuse_id_cli)
        REFERENCES bdms.codelist (id_cli) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_method_id_cli_fkey FOREIGN KEY (method_id_cli)
        REFERENCES bdms.codelist (id_cli) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_cuttings_id_cli_fkey FOREIGN KEY (cuttings_id_cli)
        REFERENCES bdms.codelist (id_cli) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_purpose_id_cli_fkey FOREIGN KEY (purpose_id_cli)
        REFERENCES bdms.codelist (id_cli) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_status_id_cli_fkey FOREIGN KEY (status_id_cli)
        REFERENCES bdms.codelist (id_cli) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_qt_bore_inc_dir_id_cli_fkey FOREIGN KEY (qt_bore_inc_dir_id_cli)
        REFERENCES bdms.codelist (id_cli) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_qt_length_id_cli_fkey FOREIGN KEY (qt_length_id_cli)
        REFERENCES bdms.codelist (id_cli) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_qt_top_bedrock_id_cli_fkey FOREIGN KEY (qt_top_bedrock_id_cli)
        REFERENCES bdms.codelist (id_cli) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_processing_status_id_cli_fkey FOREIGN KEY (processing_status_id_cli)
        REFERENCES bdms.codelist (id_cli) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_national_relevance_id_cli_fkey FOREIGN KEY (national_relevance_id_cli)
        REFERENCES bdms.codelist (id_cli) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_lithology_id_cli_fkey FOREIGN KEY (lithology_id_cli)
        REFERENCES bdms.codelist (id_cli) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_lithostrat_id_cli_fkey FOREIGN KEY (lithostrat_id_cli)
        REFERENCES bdms.codelist (id_cli) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_chronostrat_id_cli_fkey FOREIGN KEY (chronostrat_id_cli)
        REFERENCES bdms.codelist (id_cli) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT borehole_tecto_id_cli_fkey FOREIGN KEY (tecto_id_cli)
        REFERENCES bdms.codelist (id_cli) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);
...
(
    ...
    date_sty date,
    update_sty timestamp without time zone DEFAULT now(),
    updater_sty integer,
...
(
    ...
    creation_lay timestamp without time zone DEFAULT now(),
    creator_lay integer NOT NULL,
    update_lay timestamp without time zone DEFAULT now(),
